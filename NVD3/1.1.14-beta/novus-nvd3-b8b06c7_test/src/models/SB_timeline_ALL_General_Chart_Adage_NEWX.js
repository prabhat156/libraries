nv.models.timelineAndSentimentChart = function() {
  ...
  var lines = nv.models.line()
    ...
    , cumulativeArea = nv.models.stackedAreaNew0()
    ;
  ...
  function chart(selection) {
     ...
     */
      ...
      function onBrush() {
        ...
        if(plotSegments){
            ...
            segmentWrap.append('line')
                ...
                //TEST/.attr('y2', function(d,i){ return heightFocus})
            ...
            segmentWrap.append('text')
                ...
                //GOLD//.attr('y', (1*heightFocus)/3)
                .attr('y', 0)
                .attr('text-anchor', 'middle')
                //GOLD//.attr('style', 'font-size:24px; color:white; text-shadow: black 0.1em 0.1em 0.2em;')
                .attr('style', 'font-size:20px; font-family:Helvetica;color:#333333; text-shadow: black 0.1em 0.1em 0.2em;')
      ...
      function createMarkers(series, i){
          ...
          mark
              ...
              .attr('y', function(d, i){
                  if(d.y == -1){
                      ...
                      //NEW//return y(y.domain()[1]) + (i%4)*30;
                      return y(y.domain()[1]) + (d.index%4)*30;
                  } else {
          ...
          mark
              .append('text')
              .attr('x', function(d){ return x(d.x)+markerWidth/2})
              .attr('y', function(d,i){
                  if(d.y == -1){
                      //GOLD//return d.offset==0?y(y.domain()[1])+10:y(y.domain()[1])+40;
                      //return y(y.domain()[1]) + d.offset*30 + 10;

                      //NEW//return y(y.domain()[1]) + (i%4)*30 + 10;
                      return y(y.domain()[1]) + (d.index%4)*30 + 10;
                  } else {
              ...
              .attr('dy', '.32em')
              .attr('text-anchor', 'middle')
              .attr('style', 'font-family:Helvetica; color:#333333;')
