nv.models.timelineAndSentimentChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var markerData = data.filter(function(d){ return d.event});
      ...
      focusEnter.append('g').attr('class', 'nv-groupedareaWrap');
      ...
      //GOLD//// Cumulative tweet area plot
      //GOLD//var areaEnter = gEnter.append('g').attr('class', 'nv-area');
      //GOLD//areaEnter.append('g').attr('class', 'nv-x nv-axis');
      //GOLD//areaEnter.append('g').attr('class', 'nv-y nv-axis')
      //GOLD//    .append('g').attr('class', 'nv-zeroLine')
      //GOLD//    .append('line');
      //GOLD//    ;
      ...
      // Area Chart
      //GOLD//g.select('.nv-area')
      //GOLD//    .attr('transform', 'translate(0,' + (heightSentiment + dist12) + ')');
      area
        .width(availableWidth)
        .height(heightFocus);
      //GOLD//areaEnter.append('g').attr('class', 'nv-areaWrap');
      //GOLD//var focusAreaWrap = g.select('.nv-focus .nv-areaWrap').datum(timelineData);
      //GOLD//areaWrap.transition().call(area);
      //------------------------------------------------------------
     ...
     */
      ...
      function onBrush() {
        ...
        // Update area chart
        var focusAreaWrap = g.select('.nv-focus .nv-groupedareaWrap')
            .datum(timelineData
