nv.models.timelineAndSentimentChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      // Testing
      var segmentData = data.filter(function(d){ return d.segment})[0];
      segmentData.values.forEach(function(d,i,series){
          ...
          if(i==0){
              d.x0 = timelineData[0].values[0].x;
          } else {
              d.x0 = series[i-1].x;
          }
      });
      ...
      function onBrush() {
        ...
        if(plotSegments){
            ...
            segmentWrap.append('line')
                ...
                .attr('y1', 0)
                //GOLD//.attr('y2', heightFocus)
                .attr('y2', function(d,i){ return i==(segmentData.values.length-1)?0:heightFocus})
                .attr('style', "stroke:black; stroke-width:2")
                .style('stroke-dasharray', '5,5')
                ;
            
            segmentWrap.append('text')
                .attr('x', function(d){ return x(d.x0)+(x(d.x)-x(d.x0))/2})
      ...
      function createMarkers(series, i){
          ...
          mark
              ...
              .attr('y1', function(d){
                  ...
                  //GOLD//} else {
                  //GOLD//    //GOLD//return d.offset==0?y(d.y):y(d.y)-40-20

                  //GOLD//    if(y(d.y)-40-20 > 0){
                  //GOLD//        if(d.offset==0) return y(d.y);
                  //GOLD//        if(d.offset==1){
                  //GOLD//            if(y(d.y)-40-20-10-20 > 0){
                  //GOLD//                return y(d.y)-40-20;
                  //GOLD//            } else {
                  //GOLD//                return y(d.y);
                  //GOLD//            }
                  //GOLD//        }
                  //GOLD//    } else {
                  //GOLD//        if(d.offset == 0) return y(d.y);
                  //GOLD//        if(d.offset == 1) return y(d.y)+40+20;
                  //GOLD//    }
                  //GOLD//}
                  if(d.y == -1){
                      return y(y.domain()[0]);
                      ...
                      if(y(d.y)-40-30 > 0){
                          ...
                          if(d.offset == 0) return y(d.y);
                          if(d.offset == 1) return y(d.y)+40+30;
                      }
                  }
              })
              .attr('y2', function(d){
                  ...
                  //GOLD//} else {
                  //GOLD//    //GOLD//return d.offset==0?y(d.y)-40:y(d.y)-40-20-10;

                  //GOLD//    if(y(d.y)-40-20 > 0){
                  //GOLD//        if(d.offset==0) return y(d.y)-40;
                  //GOLD//        if(d.offset==1){
                  //GOLD//            if(y(d.y)-40-20-10-20 > 0){
                  //GOLD//                return y(d.y)-40-20-10;
                  //GOLD//            } else {
                  //GOLD//                return y(d.y)+40;
                  //GOLD//            }
                  //GOLD//        }
                  //GOLD//    } else {
                  //GOLD//        if(d.offset==0) return y(d.y)+40;
                  //GOLD//        if(d.offset==1) return y(d.y)+40+20+10;
                  //GOLD//    }
                  //GOLD//}
                  if(d.y == -1){
                      return y(y.domain()[1]);
                      ...
                      if(y(d.y)-40-30 > 0){
                          ...
                          if(d.offset==0) return y(d.y)+40;
                          if(d.offset==1) return y(d.y)+40+30+10;
                      }
                  }
              })
          ...
          //GOLD//mark
          //GOLD//    .append('rect')
          //GOLD//    .attr('x', function(d){ return x(d.x)})
          //GOLD//    .attr('y', function(d){
          //GOLD//        if(d.y == -1){
          //GOLD//            return d.offset==0?y(y.domain()[1]):y(y.domain()[1])+30;
          //GOLD//        } else {
          //GOLD//              //GOLD//return y(d.y)-20-40 - d.offset*20 -  d.offset*10

          //GOLD//              if(y(d.y)-40-20 > 0){
          //GOLD//                  if(d.offset == 0) return y(d.y)-40-20;
          //GOLD//                  if(d.offset == 1){
          //GOLD//                      if(y(d.y)-40-20-10-20 > 0){
          //GOLD//                          return y(d.y)-40-20-10-20
          //GOLD//                      } else {
          //GOLD//                          return y(d.y)+40
          //GOLD//                      }
          //GOLD//                  }
          ...
          //GOLD//    .attr('width', 60)
          //GOLD//    .attr('height', 20)
          //GOLD//    .attr('style', "fill-opacity:0.5;stroke-width:2;")
          //GOLD//    //GOLD//.style('fill', color(series,i))
          //GOLD//    //GOLD//.style('stroke', d3.rgb(color(series, i)).darker(0.22))
          //GOLD//    .style('fill', series.color)
          //GOLD//    .style('stroke', d3.rgb(series.color).darker(0.22))
          //GOLD//    ;
          mark
              //.append('rect')
              ...
              //.attr('y', function(d){
              //    if(d.y == -1){
              //        return d.offset==0?y(y.domain()[1]):y(y.domain()[1])+30;
              //    } else {
              ...
              .append('path')
              .attr('d', function(d){
                  //GOLD//return 'M'+x(d.x)+' '+(y(d.y)-40)+' L'+(x(d.x)+15)+' '+(y(d.y)-55)+' L'+x(d.x)+' '+(y(d.y)-70)+' Z'

                  var yLoc;
                  if(d.y == -1){
                      yLoc = d.offset==0?y(y.domain()[1])+30:y(y.domain()[1])+60;
                  } else {
                        if(y(d.y)-40-30 > 0){
                            if(d.offset == 0) yLoc = y(d.y)-40;
                            if(d.offset == 1){
                                if(y(d.y)-40-30-10-30 > 0){
                                    yLoc = y(d.y)-40-30-10;
                                } else {
                            ...
                            if(d.offset == 0) yLoc = y(d.y)+40+30;
                            if(d.offset == 1) yLoc = y(d.y)+40+30+10+30
                        }
                  }

                  return 'M'+x(d.x)+' '+yLoc+' L'+(x(d.x)+15)+' '+(yLoc-15)+' L'+x(d.x)+' '+(yLoc-30)+' Z'
                  //return yLoc;
              })
          ...
          //GOLD//mark
          //GOLD//    .append('text')
          //GOLD//    .attr('x', function(d){ return x(d.x)+30})
          //GOLD//    .attr('y', function(d){
          //GOLD//        if(d.y == -1){
          //GOLD//            return d.offset==0?y(y.domain()[1])+10:y(y.domain()[1])+40;
          //GOLD//        } else {
          //GOLD//            //GOLD//return y(d.y)-10-40 - d.offset*20 -d.offset*10

          //GOLD//              if(y(d.y)-40-20 > 0){
          //GOLD//                  if(d.offset == 0) return y(d.y)-40-20+10;
          //GOLD//                  if(d.offset == 1){
          //GOLD//                      if(y(d.y)-40-20-10-20 > 0){
          //GOLD//                          return y(d.y)-40-20-10-20+10
          //GOLD//                      } else {
          //GOLD//                          return y(d.y)+40+10
          //GOLD//                      }
          //GOLD//                  }
          //GOLD//              } else {
          //GOLD//                  if(d.offset == 0) return y(d.y)+40+10;
          //GOLD//                  if(d.offset == 1) return y(d.y)+40+20+10+10;
          //GOLD//              }
          //GOLD//        }
          //GOLD//    })
          //GOLD//    .attr('dy', '.32em')
          //GOLD//    .attr('text-anchor', 'middle')
          //GOLD//    .text(function(d,j){ return d.label})
          //GOLD//    ;
