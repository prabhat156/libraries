    ...
    selection.each(function(data) {
      ...
      // Functions
        ...
        function zoomResponse(){
            ...
            var abc = barsWrap.select('.nv-discretebar');
            abc = abc.select('g').select('.nv-groups').selectAll('rect');
            //abc.attr("transform", "translate(" + d3.event.translate[0] + ",0)");
            abc.attr("transform", "translate(" + tx + ",0)");
            //console.log(abc);
