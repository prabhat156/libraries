		...
		selection.each(function(data) {
				...
				layer.renderGuideLine = function(x) {
				 	...
				 	line.enter()
				 		...
				 		.attr("y2",0)
                        // PK : Line color: red, Line style: dashed
                        .attr('style', 'stroke:rgb(255,0,0);stroke-width:1;stroke-dasharray:2,2')
...
nv.models.discreteBarPlusLineChart = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
...
nv.models.lineWithFocusChartZoom = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  var margin = {top: 30, right: 30, bottom: 30, left: 60}
    ...
    , noData = "No Data Available."
    , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'brush', 'zoom')
    , transitionDuration = 250
    ;
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      focusEnter.append('g').attr('class', 'nv-y nv-axis');
      focusEnter.append('g').attr('class', 'nv-linesWrap');
      //focusEnter.append('g').attr('class', 'nv-x nv-zoom');
     ...
     */
     ...
     console.log(g.select('.nv-focus')); 
      //var gZoom = g.select('.nv-x.nv-zoom')
      var gZoom = g.select('.nv-focus')
            .call(zoom);  
      //------------------------------------------------------------
              ...
              data
                ...
                .map(function(d,i) {
                  return {
                    key: d.key,
                    values: d.values.filter(function(d,i) {
                      return lines.x()(d,i) >= t[0] && lines.x()(d,i) <= t[1];
                    })
                  }
                })
            );
...
nv.models.lineWithFocusChartAndControls = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      focusEnter.append('g').attr('class', 'nv-y nv-axis');
      focusEnter.append('g').attr('class', 'nv-linesWrap');
      //focusEnter.append('g').attr('class', 'nv-zeroLine');
      ...
      contextEnter.append('g').attr('class', 'nv-brushBackground');
      contextEnter.append('g').attr('class', 'nv-x nv-brush');
      //contextEnter.append('g').attr('class', 'nv-zeroLine');
      //contextEnter.append('line');
      ...
      if (showLegend) {
        ...
        //GOLD//legend.width(availableWidth);
      ...
      if (showControls) {
        //var controlsData = [
        //  //{ key: 'Count', disabled: multibar.stacked() },
        //  //{ key: 'Percentage', disabled: !multibar.stacked() }
        //  { key: 'Count', disabled: !controlState },
        //  { key: 'Percentage', disabled: controlState }
        //];
     ...
     */
      ...
      // Zero line
      //g.select('nv-focus .nv-zeroLine line')
      //  .attr("x1", 0)
      //  .attr("x2", availableWidth)
      //  .attr("y1", y(0))
      //  .attr("y2", y(0))
      //  ;
      //g.select('nv-context .nv-zeroLine line')
      //  .attr("x1", 0)
      //  .attr("x2", availableWidth)
      //  .attr("y1", y(0))
      //  .attr("y2", y(0))
      ...
      controls.dispatch.on('legendClick', function(d,i) {
        ...
        d.disabled = false;
        // PK Run the callback function if present
        if ("onClick" in d) {
            d.onClick();
        } else {
...
nv.models.lineWithFocusChartAndSentiment = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  var margin = {top: 60, right: 30, bottom: 20, left: 80}
    ...
    , showLegend = true
    , brushExtent = null
    //, brushExtent = [new Date(2012, 1, 1, 12, 0), new Date(2012, 1, 1, 12, 40)]
    , tooltips = true
    , tooltip = function(key, x, y, e, graph) {
        return '<h3>' + key + '</h3>' +
               '<p>' +  y + ' at ' + x + '</p>'
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      //var sentimentData = data.filter(function(d){return !d.disabled && d.sentiment});
      var sentimentData = data.filter(function(d){return d.sentiment});
      // This is the timeline data 
      //var timelineData = data.filter(function(d){return !d.disabled && !d.sentiment});
      ...
      //GOLD//  var noDataText = container.selectAll('.nv-noData').data([noData]);
      ...
      lines3
        ...
        .color(
          sentimentData
            ...
            .filter(function(d,i) {
              //return !sentimentData[i].disabled;
  ...
  chart.xScale1 = function(_) {
    if (!arguments.length) return xScale1;
    //xScale = _;
    lines.scatter.xScale(_);
    ////lines2.scatter.xScale(d3.time.scale());
    //lines2.scatter.xScale(_);
    //lines3.scatter.xScale(_);
    return chart;
  };

  chart.xScale2 = function(_) {
    if (!arguments.length) return xScale2;
    lines2.scatter.xScale(_);
    return chart;
  };

  chart.xScale3 = function(_) {
    if (!arguments.length) return xScale3;
    lines3.scatter.xScale(_);
    return chart;
  };
  //============================================================
...
nv.models.lineWithFocusChartNew = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
...
nv.models.logMultiBar = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
    ...
    selection.each(function(data) {
      ...
      if (stacked)
          ...
          bars.transition()
            ...
            .attr('height', function(d,i) {
                // THIS IS BUGGY for now. y(0) referes to '0'. but that is not same as yDomain[0]. Further,
                //   in some cases yDomain might not be even defined. 
                //return Math.max(Math.abs(y(getY(d,i)) - y(0)),1) || 0;
                return Math.max(Math.abs(y(getY(d,i)) - y(1)),1) || 0;
            });
...
nv.models.multiBarChartNew = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
...
nv.models.logBarChart = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------

  var multibar = nv.models.logMultiBar()
    , xAxis = nv.models.axis()
    , yAxis = nv.models.axis()
    , legend = nv.models.legend()
    , controls = nv.models.legend()
  ...
  var showTooltip = function(e, offsetElement) {
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
        ...
        x = xAxis.tickFormat()(multibar.x()(e.point, e.pointIndex)),
        //y = yAxis.tickFormat()(multibar.y()(e.point, e.pointIndex)),
        //[TODO] Make the format configurable. Currently Hard-coded
        y = d3.format(',f')(multibar.y()(e.point, e.pointIndex)),
        content = tooltip(e.series.key, x, y, e, chart);
...
nv.models.multiBarStackGroupChart = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------

  var multibar = nv.models.multiBarStackGroup()
    , xAxis = nv.models.axis()
    , yAxis = nv.models.axis()
    , legend = nv.models.legend().height(30)
    , controls = nv.models.legend().height(30)
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var wrap = container.selectAll('g.nv-wrap.nv-multiBarStackGroupChart').data([data]);
      var gEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap nv-multiBarStackGroupChart').append('g');
      var g = wrap.select('g');
      ...
      if (showXAxis) {
          xAxis
            .scale(x)
            .ticks( availableHeight / 24 )
            .tickSize(-(multibar.showValues() ? (availableWidth-multibar.valuePadding()) : availableWidth), 0)
            ;
      ...
      if (showYAxis) {
          ...
          g.select('.nv-y.nv-axis').select('.nv-axis').select('.nv-axislabel')
              .attr("style", yAxisLabelStyle)
              // Reset the placement of the y-axis label
      ...
      //TEST for bar shift with axis label length
      //TEST/multibar.margin({left: 200});
      //TEST//barsWrap.transition().call(multibar);
...
nv.models.stackedAreaNew = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      // PK Disabled the transition effect so that the area can be created more fluidly when using brush
      //GOLD//path.transition()
      path
          .attr('d', function(d,i) {
            return area(d.values,i)
          });
...
nv.models.stackedAreaNew0 = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      path
          ...
          .style('stroke', function(d,i){ return d.color || color(d, d.seriesIndex) })
          //GOLD//.style("fill-opacity", 0.06)
          //GOLD//.style("stroke-opacity", 0.06)
          // Setting opacity 0 just for some testing with y-axis for superbowl. Its a hack
          .style("fill-opacity", 0)
          .style("stroke-opacity", 0)
              ;
...
nv.models.stackedAreaNew1 = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
...
nv.models.groupedArea = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  var margin = {top: 0, right: 0, bottom: 0, left: 0}
    ...
    , getX = function(d) { return d.x } // accessor to get the x value from a data point
    //, getY = function(d) { return d.y } // accessor to get the y value from a data point
    , getY = function(d) { return d.cum } // accessor to get the y value from a data point
    , style = 'stack'
    , offset = 'zero'
    , order = 'default'
    , interpolate = 'linear'  // controls the line interpolation
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var wrap = container.selectAll('g.nv-wrap.nv-stackedareaarea').data([data]);
      var wrapEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap nv-stackedareaarea');
      var defsEnter = wrapEnter.append('defs');
      var gEnter = wrapEnter.append('g');
      var g = wrap.select('g');
